...
START_TEST(test_sub_result) {
  ...
  static const double values_c[RESULT_COUNT][MAX_RANG] = {
      {1, 2.999, -39.432, -0.98, 3.335, 7.0004, 7, 4, -9.9999999},
      {1.15799, -3.067376, 42.0063, 0.00031299, 557.887, 34.2345246, 0.5466463,
       34.5435, -8.3424, -1.00000001},
      {-7, -456456, -45, -35645, -23524, -565, -0.003, -6, 9},
      {-2.0000001},
  };
...
Suite *test_sub_suite(void) {
  ...
  tcase_add_loop_test(tc_result, test_sub_result, 0,
